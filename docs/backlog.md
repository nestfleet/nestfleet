...
| QE-08 | Add `docker image prune -a --force` to deploy CI step before pulling new images | XS | VPS disk hit 100% from accumulated images across rapid deploys — caused console ENOSPC crash. Prune before each deploy to keep disk healthy. |
