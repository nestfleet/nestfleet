...
// ── Slug indicator icon ───────────────────────────────────────────────────
// Hoisted to module scope: previously defined inside the page component's
// render body, which caused a full remount (and lost focus/state) on every
// parent render.
function SlugIndicator({ slug, slugState }: { slug: string; slugState: SlugState }) {
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            <SlugIndicator slug={slug} slugState={slugState} />
          </div>
